...
/**
 * Created by Rohaan on 17/12/17.
 */
public class QueryUtils {

    static String createStringUrl() {

        String url = "http://content.guardianapis.com/search?section=film&order-by=newest&show-tags=contributor&show-references=author&q=android&api-key=test";
        return url;
    }
